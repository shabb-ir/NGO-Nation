...
const Footer = () => {
  ...
  const handleReportModalOpen = () => {
    ...
    document.title = 'NGO-Social | Report an issue';
    setReportModal(true);
  };
          ...
          <div className="col-lg-6 col-md-6 mb-4 mb-lg-0 px-5">
            ...
            {isMobile ? (
              ...
              <p className="footer-text font-italic text-light text-left">
                With NGO-Social we aim at bringing all the various NGOs and donors
            ...
            <div className="socials justify-content-center">
              ...
              <div className="github social-btn">
                <a
                  href="https://github.com/Saurabh2402/NGO-Social"
                  rel="noreferrer"
                  target="_blank"
                >
